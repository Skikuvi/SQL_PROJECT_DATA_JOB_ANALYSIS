...
-Focus on roles with specidied salaries, regardless of location
-Why? It reveals how different skills impact salary level for data analyst and
helps indentify the most financially rewarding skills or improve
*/
...
/* The results indicate that the highest-paying data analyst roles are evolving 
beyond traditional reporting and dashboarding. Employers are increasingly rewarding 
professionals who combine analytics, machine learning, data engineering, 
cloud infrastructure, and software development skills. Analysts who can bridge
the gap between business insights and technical implementation are likely to 
